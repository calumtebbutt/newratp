...
client.on('message', message=>{
    ...
    switch(args[0]) {
        case 'botdetails':
            message.author.send(botdetails);
        break;
    }
})
...
const botdetails = ("\n\n**Bot Created by CalumT#3056**\n\nBot Help Server: https://discord.gg/V6HGAgB\n\n--------------------------------------- *Bot Created by CalumT#3056* ---------------------------------------")

const invite = ("\n\n**RATP Discord Server:** https://discord.gg/4CaCKa2\n\n--------------------------------------- *Bot Created by CalumT#3056* ---------------------------------------")
